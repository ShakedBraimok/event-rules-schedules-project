...
- `TF_STATE_BUCKET`: `senora-terraform-state-event-rules-schedules-project-6921f468bebe49e30962a743`
- `TF_STATE_KEY`: `event-rules-schedules-project/terraform.tfstate`
